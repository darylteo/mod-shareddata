...
package org.vertx.java.tests.mods.shareddata;
...
import org.vertx.mods.shareddata.impl.hazelcast.HazelcastSharedData;

/**
 * @author <a href="http://tfox.org">Tim Fox</a>
 */
public class HazelcastSharedDataTests extends TestCase {

  private final SharedData sharedData = new HazelcastSharedData();
